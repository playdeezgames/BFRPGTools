Public Class Maze(Of TDirection)
    ...
    Sub New(columns As Integer, rows As Integer, directions As IReadOnlyDictionary(Of TDirection, MazeDirection(Of TDirection)))
        Me.Columns = columns
        Me.Rows = rows
    ...
    Sub Generate()
        Reset()
        Dim cell = GetCell(RNG.FromRange(0, Columns - 1), RNG.FromRange(0, Rows - 1))
        ...
        End While
    End Sub
    Function GetCell(column As Integer, row As Integer) As MazeCell(Of TDirection)
